...
从最低层次的需求层次结构中建立派生需求和基本原理

为了帮助开发派生的需求，可能需要各种其他的模型元素，并且这些模型元素可能是通过关系的再融资来关联的。请注意，powersourceman管理是如何“通过”hsuvoperational各州模型(图8)来进行“再融资”的。请注意，这一原理也可以附加到“德里联盟”的关系中。在这种情况下，基本原理是由引用的文档“混合设计指导”提供的。
...
至此，HSUV混合动力汽车系统的所有类型图已建立完毕，由于HSUV系统设计子系统复杂用例多，本例只截取一部分进行解释，具体完整的的建模过程将在2.2节进行分析。
