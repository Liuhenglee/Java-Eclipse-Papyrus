...
“上下文关系图”指的是用户定义的内部块图，它描述了整个企业中的一些顶级实体及其关系。其所描述的每个模型元素可能包括一个图形图标，图中实体的空间关系有时也表达了理解，尽管这并不是在语义中被捕获的，还可以包括地图等背景以提供附加的上下文。
...
此处内部框图以HyperSUV为中心，定义了与驾驶人员、维护人员以及乘客之间的关系，同时定义了外部Baggage行李和Environment驾驶环境的附加上下文，驾驶环境中提出了Weather天气、Road道路以及ExternalObject外部对象等关键元素。
